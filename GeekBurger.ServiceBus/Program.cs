...
namespace GeekBurger.ServiceBus
{
    class Program
    {
        const string QueueConnectionString = "Endpoint=sb://geekburguer21.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=for1VNAX2bYby3fwCy/k4dzlJNxTCaCVuh3IwehgzGk=";
